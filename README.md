...
Довольно простой шаблон верстки для нового проекта на `Gulp+Sass`
...
- Библиотеки фронта устанавливаются через npm (не через cdn)
- На каждый шаблон подключаются свои файлы стилей и скриптов (иногда избыточно, но удобно и быстро)
- Sass файлы разбиты по сущностям


## Как работать с завивимостями front библиотек через npm
